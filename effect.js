...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#ba').stop();
			...
			$('#baa').animate({top:240, left: vw+400},500);
		});
	...
	function loopA() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#ba').animate({left:randleft,bottom:randtop},10000,function(){
			loopA();
		});
	}
	...
	$('#balloons_flying').click(function(){
		...
		$('#b2,#b3,#b6,#b8,#ba').addClass('balloons-rotate-behaviour-two');
		loopOne();
		loopTwo();
		loopThree();
		loopFour();
	...
	$('#wish_message').click(function(){
		...
		$('#b99').animate({top:240, left: vw+270},500);
		$('#baa').animate({top:240, left: vw+320},500);
